...
#define UART_BUFFER_LENGTH 50    //Maximum length allowed for UART data
#define TOPIC_BUFFER_LENGTH 15    //Maximum length allowed Topic
...
class MQTT_GC
{
  public:
    ...
    MQTT_GC(unsigned long KeepAlive);
    void begin(void);
